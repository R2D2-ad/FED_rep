...
/* ----------------------------------------------------------------
	Main
-----------------------------------------------------------------*/
basic.style.border = '1px solid purple';
basic.style.backgroundColor = '#483d8b';
basic.style.padding = '30px';
basic.style.margin = '85px 26px';
basic.style.borderRadius = '15px';
